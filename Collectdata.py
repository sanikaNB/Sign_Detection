...
while True:
    _,frame=cap.read()
    count = {
             'a': len(os.listdir(directory+"/My")),
             'b': len(os.listdir(directory+"/Where")),
             'c': len(os.listdir(directory+"/Mother")),
             'd': len(os.listdir(directory+"/Father")),
             ...
             # 'a': len(os.listdir(directory + "/I_Love_You")),
             # 'b': len(os.listdir(directory + "/Thanks")),
             # 'c': len(os.listdir(directory + "/Hello")),
             # 'd': len(os.listdir(directory + "/Peace")),
             # 'e': len(os.listdir(directory + "/You")),
             # 'f': len(os.listdir(directory + "/OK")),
             # 'g': len(os.listdir(directory + "/Good_Luck")),
             # 'h': len(os.listdir(directory + "/How")),
             # 'i': len(os.listdir(directory + "/Friends")),
             # 'J': len(os.listdir(directory + "/What")),
    ...
    if interrupt & 0xFF == ord('a'):
        cv2.imwrite(directory+'My/'+str(count['a'])+'.png',frame)
    if interrupt & 0xFF == ord('b'):
        cv2.imwrite(directory+'Where/'+str(count['b'])+'.png',frame)
    if interrupt & 0xFF == ord('c'):
        cv2.imwrite(directory+'Mother/'+str(count['c'])+'.png',frame)
    if interrupt & 0xFF == ord('d'):
        cv2.imwrite(directory+'Father/'+str(count['d'])+'.png',frame)
